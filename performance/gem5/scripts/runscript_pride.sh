...
#RUN CONFIG
MAX_INSTS=250000000                      # Number of instructions to be simulated
STATS_CONFIG="pride_multiprogram_16GBmem_250Mn"
INST_TAKE_CHECKPOINT=25000000000           # Instruction count after which checkpoint was taken
CHECKPOINT_CONFIG="multiprogram_16GBmem_25Bn"    # Name of directory inside CKPT_PATH
...
# Output Dir
OUTPUT_DIR=$GEM5_PATH/stats/${STATS_CONFIG}.SPEC${SPEC_VERSION}.C${NUM_CORES}/$RUN_CONFIG/$BENCHMARK
...
echo "$GEM5_PATH/build/X86/gem5.opt \
    ...
    --num-cpus=$NUM_CORES --mem-size=16GB --mem-type=DDR5_2400_32x4 --mem-ranks=1 \
